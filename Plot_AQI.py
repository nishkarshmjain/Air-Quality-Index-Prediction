# -*- coding: utf-8 -*-
"""
Created on Sat Jun 20 15:19:21 2020

@author: Nishkarsh Jain
"""
...
if __name__=="__main__" :
    ...
    plt.plot(range(0,365),ls2013, label="2013 AQI Data")
    plt.plot(range(0,364),ls2014, label="2014 AQI Data")
    plt.plot(range(0,365),ls2015, label="2015 AQI Data")
